...
export function ManifestoSection() {
  return (
    <section className="bg-bone-50 pb-24 pt-section text-navy sm:pb-32">
      <div className="container-editorial">
        <div className="grid gap-y-14 lg:grid-cols-12 lg:gap-x-8">
          <Reveal className="lg:col-span-5 lg:sticky lg:top-32 lg:self-start">
            ...
            <h2 className="mt-5 text-display-md font-semibold text-navy">
              {manifesto.claim}
            </h2>
          ...
          <div className="lg:col-span-6 lg:col-start-7">
            ...
            <Reveal delay={180} className="mt-12">
              ...
              <Link
                href="/sobre"
                className="group/link mt-8 inline-flex items-center gap-3 text-sm font-medium tracking-tight text-navy/70 transition-colors duration-300 hover:text-brand"
              >
